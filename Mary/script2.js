...
window.onresize = function (event) {
  recize_notes();
       ...
       document.addEventListener("DOMContentLoaded", function () {
        // Obtén el elemento envelop
        var envelop = document.querySelector(".envelop");

        // Agrega un event listener para los clics en el documento
        document.addEventListener("click", function (event) {
            // Verifica si el clic ocurrió dentro de envelop o no
            if (!envelop.contains(event.target)) {
                // Redirige a flowers.html si el clic ocurrió fuera de envelop
